...
<div id="patientDemographicsEdit">
	<openmrs:hasPrivilege privilege="Edit Patients">
		...
		<a href="${pageContext.request.contextPath}/admin/patients/shortPatientForm.form?patientId=${model.patient.patientId}"><openmrs:message code="Patient.edit"/></a><br /><br />
